...
def fill_neighborhoods(amap_old : ASectorMap,
                       n_min    : float = 4) -> ASectorMap:
...
def iterate_fill_neighborhoods(amap_old : ASectorMap,
                               n_min    : float = 4) -> ASectorMap:
...
def fill_neighborhoods_descending(amap_old       : ASectorMap,
                                  max_cycles     : float = 10,
                                  first_num_nbhs : float = 5) -> ASectorMap:
    num_cycles = 0
    amap_new = amap_copy(amap_old)
